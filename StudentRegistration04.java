...
public class StudentRegistration04 {
    public static void main(String[] args) {
        List<Course> courses = new ArrayList<>();
        courses.add(new Course("UD101", "Udemy",
                "Learning the web development and  designing - UDEMY.", 50, "Mon/Wed 9:00 AM - 10:30 AM"));
        courses.add(new Course("IS102", "LINKDIN LEARNING", "Linkdin Learning for Data science .", 40,
                "Tue/Thu 11:00 AM - 12:30 PM"));
        courses.add(new Course("NP103", "NPTEL", "NPTEL -For Cloud Computing.", 30,
                "Wed/Fri 2:00 PM - 3:30 PM"));

        List<Student> students = new ArrayList<>();
        students.add(new Student(101, "John Doe"));
        students.add(new Student(102, "Jane Smith"));
